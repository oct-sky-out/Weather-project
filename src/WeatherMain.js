    ...
    const fetchData = async () => {
      try {
        const res = await axios.get(
          cityName === "local"
            ? `http://api.openweathermap.org/data/2.5/weather?lat=${currentLocation.latitude}&lon=${currentLocation.longitude}&appid=e4477edaeda4de89e0f1c1ec47719f0b&lang=kr&units=metric`
            : `http://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=e4477edaeda4de89e0f1c1ec47719f0b&lang=kr&units=metric`
        );
        setWeather(res.data);
      } catch (e) {
        console.log(e);
